...
defmodule Chess.Piece.Moves do
  ...
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :dragon, color: color},
          {row, col}) do
  ...
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :wizard, color: color},
          {row, col}) do
  ...
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :ninja, color: color},
          {row, col}) do
  ...
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :phoenix, color: color},
          {row, col}) do
  ...
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :king, color: color},
          {row, col}) do
  ...
  # Pawn movements
  def get(%Chess.Board{cells: cells},
          %Chess.Piece{type: :pawn, color: color},
          {row, col}) do
